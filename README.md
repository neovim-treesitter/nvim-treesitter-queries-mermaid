# nvim-treesitter-queries-mermaid

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-mermaid/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-mermaid/actions/workflows/validate.yml)

Neovim tree-sitter queries for **mermaid**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-mermaid",
...
- [ ] Changes are scoped to `mermaid` — do not include files for other languages
